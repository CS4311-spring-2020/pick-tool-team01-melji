...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setFixedSize(420, 167)
        self.verticalScrollBar = QtWidgets.QScrollBar(Dialog)
        self.verticalScrollBar.setGeometry(QtCore.QRect(400, 0, 21, 141))
        self.verticalScrollBar.setOrientation(QtCore.Qt.Vertical)
        self.verticalScrollBar.setObjectName("verticalScrollBar")
        self.gridLayoutWidget = QtWidgets.QWidget(Dialog)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 401, 172))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setText(_translate("Dialog", "undo/redo"))
        self.pushButton_7.setText(_translate("Dialog", "undo/redo"))
        self.label.setText(_translate("Dialog", "change 1"))
        self.pushButton_8.setText(_translate("Dialog", "undo/redo"))
        self.pushButton_6.setText(_translate("Dialog", "undo/redo"))
        self.label_3.setText(_translate("Dialog", "change 3"))
        self.label_2.setText(_translate("Dialog", "change 2"))
        self.label_4.setText(_translate("Dialog", "change 4"))
